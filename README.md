...
#### Via composer
```bash
composer require angelapi-php/angelbroking
```
...
Download [socket.js](https://raw.githubusercontent.com/angelbroking-github/angelapi-php/main/src/socket.js) from src/socket.js and add it to your assets folder
